...
st.title('Strokes Prediction Model')
st.write()
st.write('This model will predict weather a person will have a stroke or not depending on his/her vitals and other important factors')
st.write(" ")
st.write(" ")
st.write(" ")
